...
for method in methods:
    ...
    name = f"{path}/small_all_mcs_data_shap_{method}_{dataset_name}_{model_name}_{num_datapoints}_{num_samples}_{num_bootstrap}.npy"
...
if save:
    for item in res_data_shap:
        ...
        np.save(f"{path}/small_all_mcs_data_shap_{method}_{dataset_name}_{model_name}_{num_datapoints}_{num_samples}_{num_bootstrap}.npy", all_mcs)
        np.save(f"{path}/small_all_afs_data_shap_{method}_{dataset_name}_{model_name}_{num_datapoints}_{num_samples}_{num_bootstrap}.npy", all_afs)
        np.save(f"{path}/small_all_min_afs_data_shap_{method}_{dataset_name}_{model_name}_{num_datapoints}_{num_samples}_{num_bootstrap}.npy", all_min_afs)
...
for method in methods:
    print(f"{method} started running")
    name = f"{path}/small_all_mcs_beta_shap_{method}_{dataset_name}_{model_name}_{num_datapoints}_{num_samples}_{num_bootstrap}.npy"
    if load and os.path.exists(name):
        print("results exist. Skipping this method...")
...
if save:
    for item in res_beta_shap:
        method, all_mcs, all_afs, all_min_afs, _, _ = item
        np.save(f"{path}/small_all_mcs_beta_shap_{method}_{dataset_name}_{model_name}_{num_datapoints}_{num_samples}_{num_bootstrap}.npy", all_mcs)
        np.save(f"{path}/small_all_afs_beta_shap_{method}_{dataset_name}_{model_name}_{num_datapoints}_{num_samples}_{num_bootstrap}.npy", all_afs)
        np.save(f"{path}/small_all_min_afs_beta_shap_{method}_{dataset_name}_{model_name}_{num_datapoints}_{num_samples}_{num_bootstrap}.npy", all_min_afs)
